...
import { Sparkles, CheckCircle2, ShieldCheck, Hand } from 'lucide-react';

export default function PredictionDisplay({ prediction, rawHandedness }) {
    ...
    <div className="prediction-card glass-panel glow-border">
      ...
      <div className="prediction-footer">
        <div className="joint-stat">
          ...
          <span>21 MediaPipe Joint Coordinates Extracted</span>
        </div>
      </div>
    </div>
  );
